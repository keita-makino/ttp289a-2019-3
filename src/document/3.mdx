...
<img src={require('../image/image2.png')} width={'60%'} />
...
<img src={require('../image/image3.png')} width={'60%'} />
...
<img src={require('../image/image4.png')} width={'60%'} />
...
|                        | $\mathcal{L}(MS)$: -118.013 | $\rho^2_{(MS)}$: 0.475 | Adj. $\rho^2_{(MS)}$: 0.441 |
...
|                        | $\mathcal{L}(MS)$: -118.013 | $\rho^2_{(MS)}$: 0.477 | Adj. $\rho^2_{(MS)}$: 0.443 |
...
|                        | $\mathcal{L}(MS)$: -118.013 | $\rho^2_{(MS)}$: 0.486 | Adj. $\rho^2_{(MS)}$: 0.452 |
